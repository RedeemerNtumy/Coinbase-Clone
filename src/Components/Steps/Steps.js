...
const Steps = () => {
    return (
        <section className='steps-main-div'>
            <div className='steps-wrapper'>
                <h2 className='h2-wrapper'>Get started in a few minutes</h2>
                <h2 className='h2-wrapper1'>Coinbase supports a variety of the most popular digital currencies.</h2>
                <div className='step-images'>
                    <div className='step-images1'>
                        <svg className="step-svg1" width="64" height="60" viewBox="0 0 64 60" fill="none"><path d="M32 16a8 8 0 100-16 8 8 0 000 16zM32 20c-11.05 0-20 7.16-20 16v18h40V36c0-8.84-8.95-16-20-16z" fill="#56B4FC"></path><path d="M64 36H0v24h64V36z" fill="#BFE9FF"></path><path d="M52 36H12v24h40V36z" fill="#1652F0"></path><path d="M33 42h-2v12h2V42z" fill="#fff"></path><path d="M38 49v-2H26v2h12z" fill="#fff"></path></svg>
                        <h2 className='link-bank'>Create an account</h2>
                    </div>
                    ...
                    <div className='step-images2'>
                        ...
                        <h2 className='link-bank'>Link your bank account
                        </h2>

                    </div>
                    <div className='divide2'></div>
                    <div className='step-images3'>
                        <svg width="61" height="56" viewBox="0 0 61 56" fill="none">
                            <path d="M40 40.5v-.99c0-.89-.59-1.68-1.45-1.92l-9.21-2.63a7.975 7.975 0 00-6.31.83L16 40v12h15.65c2.88 0 5.73-.52 8.43-1.53L60 43c.9-2.26-.93-4.67-3.35-4.39L40 40.5z" fill="#56B4FC"></path>
                        ...
                        <h2 className='link-bank'>Start buying & Selling
                        </h2>
                    </div>
                </div>
