...
import './Manage.css'
import stat from './img/stats.webp'
                ...
                <div className='overview-div'>
                    <div className='overview-div1-1'>
                        <div className='overview-f'>
                            ...
                            <div>
                                ...
                                <p className='manage-text-word'>Buy and sell popular digital currencies, keep track of them in the one place.</p>
                            </div>
                        </div>
                        <div className='overview-f'>
                            <div className='overview-icons'>
                            ...
                            <div>
                                ...
                                <p className='manage-text-word'>Invest in cryptocurrency slowly over time by scheduling buys daily, weekly, or monthly.</p>
                            </div>
                        </div>
                        <div className='overview-f'>
                            <div className='overview-icons'>
                            ...
                            <div>
                                ...
                                <p className='manage-text-word'>For added security, store your funds in a vault with time delayed withdrawals..</p>
                            </div>
                        </div>
                        <div className='overview-f'>
                            <div className='overview-icons'>
                            ...
                            <div>
                                ...
                                <p className='manage-text-word'>Stay on top of the markets with the Coinbase app for <a className='manage-links' target="_blank" rel="noopener noreferrer" href="https://play.google.com/store/apps/details?id=com.coinbase.android">Android</a> or
                                    <a className='manage-links' target="_blank" rel="noopener noreferrer" href="https://itunes.apple.com/us/app/coinbase-buy-sell-bitcoin/id886427730"> iOS</a>. </p>
                    ...
                    <div className='overview-div-1-2'>
                        <picture className='manage-picture'>
                            <img className='manage-img' src={stat} />
                        </picture>
